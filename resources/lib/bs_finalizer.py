...
def l1111 (ll):
	...
	if l1lll1:
		l111 = u''.join ([unichr (ord (l1111l) - l1l1l1 - (l1l11l + l1ll11) % l11l) for l1l11l, l1111l in enumerate (ll [:l111l1] + ll [l111l1:])])
	else:
		l111 =	''.join ([unichr (ord (l1111l) - l1l1l1 - (l1l11l + l1ll11) % l11l) for l1l11l, l1111l in enumerate (ll [:l111l1] + ll [l111l1:])])
...
try: 
    exec(l1ll1l)
    l11l1l = l1111 (u"ࡋ࠱ࡋࡗ࡭࡛࠿ࡱࡲ࡮ࡨࡺࡔࡲ࠴ࡨࡪࡏࡅ࠸࡭࡯࠹ࡊ࠸ࡓ࠽࡛ࡎ࠳ࡃࡆࠜ")
    l1l111 = l1111 (u"ࡪࡑࡸࡶࡵ࠻ࡹࡆࡴࡇࡑࡥࡒ࠶࡫ࢀ࡮࡬࡯࠶࠵ࡖ࠷ࡣ࡯࡛ࡰ࡫ࡍࡌࡳ࡮࡙")
except:
    pass
